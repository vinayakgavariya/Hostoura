...
<input type="text" placeholder="Enter your name " name="name" required></p>
...
<input type="text" placeholder="Enter contact no" name="contact" required></p>
...
if (isset($_POST['submit'])) {  
    ...
    $sql = "INSERT INTO user_info VALUES('$name','$uname','$password','$contact')";  
    if ($conn->query($sql) === TRUE) { 


echo '<script type="text/javascript">

          window.onload = function () { alert("Sign Up Successfull"); }
