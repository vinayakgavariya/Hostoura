...
if (isset($_POST['submit'])) {  
    ...
    if ($conn->connect_error) {  
      ...
      $sql = "SELECT * FROM user_info WHERE User_Name = '$myusername' and Password = '$mypassword'";
      ...
      if($count == 1) {
         ...
         window.onload = function () { alert("Log In Successfull, Welcome "); }
</script>';
        ...
        window.onload = function () { alert("Log In UnSuccessfull"); }
